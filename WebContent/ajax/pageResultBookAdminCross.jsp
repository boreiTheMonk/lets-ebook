...
<s:if test="#stat.index % 5 == 0 && #stat.index!=0">
 ...
 <s:url id="show_Books" action="showMyBook" >
	...
	<div class="horizontal-scroll-tab2">
		...
		<s:a href="%{show_Books}"><img src="/<s:property value='@constant.Application@FOLDER_BOOK_IMAGE_URL'/>/<s:property value='linkImage'/>" width="83px" height="103px" alt="" border="0"class="img-border-gray" /></s:a>
