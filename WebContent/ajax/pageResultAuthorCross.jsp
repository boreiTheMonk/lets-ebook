...
<body>
    ...
    <s:url id="url_show_author" action="show_author" >
                    ...
                    <div class="amis-tab"> <span><span class="cursor" onclick="confirm_delete('<s:property value='idMember' />','<s:property value='login' />',this)"><img src="images/cross-icon.gif" alt="" border="0" class="popup-link-amis" /></span></span> <s:a href="%{url_show_author}"><img src="/<s:property value="@constant.Application@FOLDER_MEMBER_IMAGE_URL"/>/<s:property value="avatarUrl"/>" alt="" border="0" class="img-border-gray" height="48px" width="48px" /></s:a> 
