...
<body>
   <div id="content-area">
     ...
     <h1>Selection des parties a afficher</h1>
		...
		<img   src="/<s:property value="@constant.Application@FOLDER_TMP_IMAGE_URL"/>/<s:property value="#session[@constant.Application@AVATAR_TEMP]"/>" id="cropbox"  style="display: block;" alt="image"/>
		</div>
		
		 <form id="crop_form" action="cropImageAvatar_register">
