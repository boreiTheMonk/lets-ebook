          ...
          <div class="content-padd">
            <div class="content-area-border-div">
              ...
              <%//<a href="/<s:property value="@constant.Application@FOLDER_BOOK_URL"/>/<s:property value="showBook.linkBook" />" class="Consultation-btn2"> %> 
               ...
               <a href="downloadBookDemo?bookId=<s:property value="showBook.idBook" />" class="Consultation-btn2">
               
                télécharger<br />
                  l'extrait</a>
                  <s:if test="showBook.isValid==true"> 
                  <a href="buyBook?bookId=<s:property value="showBook.idBook" />" class="Consultation-btn3" >Acheter</a> 
                   </s:if>
                  </div>
