...
function pageselectCallbackBook(page_index, jq){
	...
	$("#searchResults").load('categoryPaginateBook',{id_category:<s:property value="id_category"/>,my_deco:"empty_inline",min:(10*(page_index+1))-10,max:10} );
	//alert("ok");
 ...
 <div id="content-area">
          <div class="border-heading-div">
            <div class="bg-heading-div">
              <div class="main-heading-div"><s:property value="category.name"/></div>
            ...
            <div class="content-area-border-div left">
              <div class="content-tab-cover left">
                <div class="tab-content left">
                  ...
                  <div id="searchResults" class="left" > il n'y a pas de livres pour le moment </div>
