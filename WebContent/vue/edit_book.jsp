...
categories[<s:property value="#stat.index" />]="<s:property value="name" />";
	...
	function updateSubCategories(){
		...
		bool=0;
		idSelect=<s:property value="enfant"/>;
		for (i=0;i < subCategories.length ; i++){
			
			if(subCategories[i]['id']==id_category){
				bool=1;
				opt = new Option();
				//select opt match exitingold categories
				if(subCategories[i]['value']==idSelect)
          ...
          <div class="border-heading-div">
            <div class="bg-heading-div">
              ...
              <div class="top-heading-icon"><img src="images/upload-icon.png" width="36" height="29" alt="" border="0" class="margin-top-5" /></div>
           	<div class="tabs-nav"><a href="showEditUploadBook?bookId=<s:property value='bookId' />">Upload</a><a  class="tab-select">Informations</a></div>
            </div>
          	
          </div>
          <div class="content-padd">
            <div class="content-area-border-div left">
              <div class="form-heading"><em>Editer mon livre</em></div>
              <form  method="post"  action="validModifBook" id="form_edit_book"  enctype="multipart/form-data">
                ...
                <div class="combo-row">
                  ...
                  <div class="combo-col-right">
                    <div class="left margin-left-5">
                     ...
                     <s:iterator value="#application['catList']" var="c" status="stat">
					<option value="<s:property value="idCategory" />" <s:if test="parent ==idCategory"> selected="selected" </s:if> ><s:property value="name" /></option>
                ...
                <dl class="form">
                  <dd >
                   ...
                   <dd >
                    ...
                    <div class="error_img"></div>
                    <input name="b.author" id="b.author" value="<s:property value='b.author'/>" type="text" maxlength="50" class="form-input1 validated"  />
                    <div  class="msg"></div>
                  </dd>
