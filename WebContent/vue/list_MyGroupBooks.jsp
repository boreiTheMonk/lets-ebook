...
function pageselectCallbackBook(page_index, jq){
	...
	$("#searchResults").load('listPaginateMyGroupBooks',{'groupId':<s:property value="groupId"/>,my_deco:"empty_inline",min:(10*(page_index+1))-10,max:10} );
	//alert("ok");
...
function confirm_delete (idBook,title,wrap){
	...
	//delete old click event for previous choice
	$('#button_delete').unbind('click');
	 $("#button_delete").click(function(){
		 ...
		 if( submitOnce==0){
				...
				submitOnce=1;
			$.post('delete_mybook_group',{ 'groupId':<s:property value="groupId"/>,"bookId": idBook ,"my_deco":"empty_inline"}, function(data,textStatus,http) {
 ...
 <div id="content-area">
          <div class="border-heading-div">
            <div class="bg-heading-div">
              <div class="main-heading-div">Mes livres</div>
         ...
         <div id="popupContact" style="padding-top: 10px; height: 88px;" class="popupsmall_bg">
  	<div class="popupsmall-innearea" >
    <p class="size-txt12"><span id="book_title"></span> <br />sera enlevé de ce groupe. Continuer?
