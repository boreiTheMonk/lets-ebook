...
function pageselectCallbackAuthor(page_index, jq){
	...
	$("#searchResults").load('listPaginateFavouriteAuthors',{my_deco:"empty_inline",min:(10*(page_index+1))-10,max:10} );
...
function confirm_delete (idAuthor,name,wrap){
	...
	$('#button_delete').unbind('click');
	 $("#button_delete").click(function(){
			...
			$.post('delete_author_follow',{ "idMember": idAuthor ,"my_deco":"empty_inline"}, function(data,textStatus,http) {
...
<body>
        ...
        <div id="content-area">
          <div class="border-heading-div">
            <div class="bg-heading-div">
              <div class="main-heading-div">Mes auteurs favoris</div>
              <div class="top-heading-icon"><img src="images/amis-icon.png" width="26" height="26" alt="" border="0" class="margin-top-3" /></div>
              <div class="main-heading-right-txt"><span class="blue-txt size-txt12">Total : <s:property value="nbfriends"/> Auteurs favoris</span></div>
            </div>
          </div>
 ...
 <div id="popupContact" class="popupsmall_bg">
    ...
    <p class="size-txt12"><span id="member_name"></span> <br />sera enlevé de vos favoris?
