...
function pageselectCallbackAuthor(page_index, jq){
	...
	$("#searchResults").load('listPaginateWatchers',{my_deco:"empty_inline",min:(10*(page_index+1))-10,max:10} );
	//alert("ok");
        ...
        <div id="content-area">
          <div class="border-heading-div">
            <div class="bg-heading-div">
              <div class="main-heading-div">Watchers</div>
              <div class="top-heading-icon"><img src="images/amis-icon.png" width="26" height="26" alt="" border="0" class="margin-top-3" /></div>
              <div class="main-heading-right-txt"><span class="blue-txt size-txt12">Total : <s:property value="nbfriends"/> Auteurs vous suivent</span></div>
            </div>
          </div>
