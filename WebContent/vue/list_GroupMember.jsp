...
function initPaginationAuthor() {
    var num_entries = <s:property value="nbMemberGroup"/>;
...
function pageselectCallbackAuthor(page_index, jq){
	...
	$("#searchResults").load('listPaginateGroupMember',{'groupId':<s:property value="groupId"/>,my_deco:"empty_inline",min:(10*(page_index+1))-10,max:10} );
        ...
        <div id="content-area">
          <div class="border-heading-div">
            <div class="bg-heading-div">
              <div class="main-heading-div">Membres du groupe</div>
            ...
            <div class="content-area-border-div left">
              <div class="content-tab-cover left">
                <div class="tab-content left">
                  ...
                  <div id="searchResults" class="left"> pas de membre. </div>
