	...
	$('#button_delete')
	 $("#button_delete").click(function(){
		 if( submitOnce==0){
			...
			$.post('delete_Mybook',{ "bookId": idBook ,"my_deco":"empty_inline"}, function(data,textStatus,http) {
...
<body>
 <div id="content-area">
    ...
    <p class="size-txt12"><span id="book_title"></span> <br />sera enlevé de vos livres. Tout ses liens
   disparaîtront. Continuer?
