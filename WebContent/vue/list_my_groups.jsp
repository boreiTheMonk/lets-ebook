...
function pageselectCallbackGroup(page_index, jq){
	...
	$("#searchResults").load('listPaginateMyGroups',{my_deco:"empty_inline",min:(10*(page_index+1))-10,max:10} );
	//alert("ok");
	...
	$('#button_delete').unbind('click');
	 $("#button_delete").click(function(){
		 ...
		 if( submitOnce==0){
				...
				submitOnce=1;
			$.post('delete_joined_group',{ "groupId": idGroup ,"my_deco":"empty_inline"}, function(data,textStatus,http) {
  ...
  <div id="content-area">
          <div class="border-heading-div">
            <div class="bg-heading-div">
              <div class="main-heading-div">Mes Groupes Ajout&eacute;s</div>
            ...
            <div class="content-area-border-div left">
              <div class="content-tab-cover left">
                <div class="tab-content left">
                  <div class="breadcrumb">Total : <s:property value="nbGroups"/> Groupes ajout&eacute;s</div>
                  <div id="searchResults" class="left"> pas de groupe ajouté. </div>
