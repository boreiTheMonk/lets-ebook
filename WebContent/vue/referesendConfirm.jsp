 ...
 <div id="content-area">
          <div class="none-border-heading-div">
            <div class="bg-heading-div">
              <div class="main-heading-div">Confirmation d'envoi</div>
          ...
          <div class="content-padd">
            <div class="content-area-border-div left">
              <div style="text-align: center;margin: 10px 0;font-size: 15px">les invitations ont été envoyés aux destinataires</div>
