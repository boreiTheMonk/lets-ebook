...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>éditer un nouveau groupe</title>
    ...
    <div id="content-area">
          ...
          <div class="content-padd">
            <div class="content-area-border-div left">
              <div class="form-heading"><em>Editer un groupe</em></div>
              <form  method="post"  action="update_group"  enctype="multipart/form-data">
                <dl class="form">
                  <dd >
                ...
                <div class="combo-row">
                  ...
                  <div class="combo-col-right">
					...
					<option value="<s:property value="idTheme" />"   <s:if test="themeGroup ==idTheme"> selected="selected" </s:if> >     <s:property value="name" /></option>
                ...
                <dl class="form">
                  ...
                  <div class="form-col-right">
                    <div class="padding-left15">
                      <input type="submit" name="button3" id="button3" value="Modifier" class="btn-blue" />
                    </div>
                  </div>
                </div>
              </form>
