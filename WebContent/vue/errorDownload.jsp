 ...
 <div id="content-area">
          <div class="none-border-heading-div">
            <div class="bg-heading-div">
              <div class="main-heading-div">Erreur de téléchargement</div>
          ...
          <div class="content-padd">
            <div class="content-area-border-div left">
              <div style="text-align: center;margin: 10px 0;font-size: 15px">Erreur, vous n'avez pas le droit de télécharger ce livre</div>
