...
function pageselectCallbackBook(page_index, jq){
	...
	$("#searchResults").load('listPaginateGroupBooks',{'groupId':<s:property value="groupId"/>,my_deco:"empty_inline",min:(10*(page_index+1))-10,max:10} );
	//alert("ok");
...
function confirm_delete (idBook,title,wrap){
	...
	$('#button_delete').unbind('click');
	 $("#button_delete").click(function(){
			$.post('delete_book_follow',{ "bookId": idBook ,"my_deco":"empty_inline"}, function(data,textStatus,http) {
 ...
 <div id="content-area">
          <div class="border-heading-div">
            <div class="bg-heading-div">
              <div class="main-heading-div">Livre de groupe</div>
    ...
    <p class="size-txt12"><span id="book_title"></span> <br />sera enlevé de vos favoris?
