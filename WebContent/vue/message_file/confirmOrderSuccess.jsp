...
<title>lets ebook - confirmation paiement</title>
 ...
 <div id="content-area">
          <div class="none-border-heading-div">
            <div class="bg-heading-div">
              <div class="main-heading-div">confirmation</div>
          ...
          <div class="content-padd">
            <div class="content-area-border-div left">
              <div style="text-align: center;margin: 10px 0;font-size: 15px">Merci de votre paiement, la commande a été traité avec succès. </div>
                ...
                <div class="form-row">
                  ...
                  <div class="form-col-right">
                    <div class="padding-left15">
                      <input type="submit" name="button3" id="button3" value="accès au livre" class="btn-large-blue" />
                    </div>
                  </div>
                </div>
              </form>
