 ...
 <div id="content-area">
          ...
          <div class="content-padd">
            <div class="content-area-border-div left">
              <div style="text-align: center;margin: 10px 0;font-size: 15px">veuillez valider votre compte en cliquant sur le lien dans le mail qui vous a été envoyé.<br/>
              <a href="resend_register?m.login=<s:property value='me.login' />">renvoyer un mail </a>
              </div>
                ...
                <div class="form-row">
                  ...
                  <div class="form-col-right">
                    <div class="padding-left15">
                      <input type="submit" name="button3" id="button3" value="Accueil" class="btn-blue" />
                    </div>
                  </div>
                </div>
              </form>
