...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
       ...
       <%//  <link rel="stylesheet" media="screen" type="text/css" title="Design" href="<s:url value="/vue/block.css"/>" /> %>
        <title>administration de groupe</title>
...
if( submitOnce==0){
      ...
      <div id="content-area">
          <div class="border-heading-div">
            <div class="bg-heading-div">
              <div class="main-heading-div">Info groupe</div>
            ...
            <div class="content-area-border-div left">
              <div class="content-tab-cover left">
                <div class="inner-heading-cover">
                  ...
                  <div class="write-icon" style="width: 140px"> 
                  
                  <input type="hidden" id="butFollow" class="btn-large-gray" value="disoudre" onclick="deleteGroup()"/>
                  
                   <a href="show_edit_group?groupId=<s:property value="groupId"/>"><img src="images/comment-write-icon.gif" alt="" width="26" height="16" border="0" align="right" /></a>
    ...
    <p class="size-txt12"> Veuillez choisir le livre à insérer<br />
                <select name="idBook"  id="idBook">
                   <s:iterator value="myBooks" var="b" >
