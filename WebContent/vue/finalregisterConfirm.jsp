 ...
 <div id="content-area">
          <div class="none-border-heading-div">
            <div class="bg-heading-div">
              <div class="main-heading-div">fin de votre inscription</div>
          ...
          <div class="content-padd">
            <div class="content-area-border-div left">
              <div style="text-align: center;margin: 10px 0;font-size: 15px">merci de votre confirmation, vous pouvez maintenant vous connecter.</div>
