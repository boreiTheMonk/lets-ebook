...
public class ThemeHome {
	...
	public Theme merge(Theme detachedInstance) {
		...
		try {
			Theme result = (Theme) sessionFactory.getCurrentSession().merge(
					detachedInstance);
	...
	public Theme findById(int id) {
		...
		try {
			Theme instance = (Theme) sessionFactory.getCurrentSession().get(
					"model.persistance.Theme", id);
			if (instance == null) {
	...
	public List findByExample(Theme instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria(
					"model.persistance.Theme").add(Example.create(instance))
					.list();
